...
public class TransactionService {
    ...
    public Transaction createNewTransaction(User owner, String sender,
    ...
    public List<Transaction> getLastFourTransactions(Wallet wallet) {
        ...
        return transactionRepository.findAllBySenderOrReceiverOrderByCreatedOnDesc(wallet.getId().toString(),
